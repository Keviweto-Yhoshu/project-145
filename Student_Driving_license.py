...
def driving_license():
    var_id = '1029384756'
    print(type(var_id))
    var_name = "Keviweto Yhoshu"
    print(type(var_name))
    var_dob = "21/04/2010"
    print(type(var_dob))
    var_pin = "029164"
    print(type(var_pin))
    var_address = "Dimapur, Nagaland, India"
    print(type(var_address))
    var_vehicles = "2 wheelers & 4 wheelers"
    print(type(var_vehicles))
    ...
    label_vehicle_type["text"] = var_vehicles
    
    
    
    
# Create a button
button1 = Button(root, text = "Show My Driving License", command = driving_license)
